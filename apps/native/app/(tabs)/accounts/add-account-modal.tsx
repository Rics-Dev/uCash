...
const ACCOUNT_TYPES = [
  ...
  { id: "investment", label: "Investment", icon: "bar-chart-outline", description: "Stocks, crypto, ETFs" },
  { id: "loan", label: "Loan/Debt", icon: "remove-circle-outline", description: "Money you owe" },
  { id: "asset", label: "Asset", icon: "cube-outline", description: "Valuables with worth" },
] as const;
  ...
  const handleSave = () => {
    ...
    switch (accountType) {
      ...
      case "credit":
        ...
        typeSpecificData.interestRate = interestRate;
        break;
      case "cash":
        typeSpecificData.location = location;
        break;
      case "investment":
        typeSpecificData.investmentType = investmentType;
        typeSpecificData.exchange = exchange;
        break;
      case "loan":
        typeSpecificData.interestRate = interestRate;
        typeSpecificData.minimumPayment = minimumPayment;
        typeSpecificData.nextPaymentDate = nextPaymentDate;
        typeSpecificData.loanTerm = loanTerm;
        typeSpecificData.originalLoanAmount = originalLoanAmount;
        break;
      case "asset":
        typeSpecificData.assetCategory = assetCategory;
        typeSpecificData.purchaseDate = purchaseDate;
        break;
    }
                ...
                <View className="overflow-hidden rounded-2xl border border-neutral-200 bg-white/50 dark:border-neutral-800 dark:bg-transparent">
                  ...
                  >
                    <TextInput
                      ...
                      className="flex-1 font-medium text-base text-neutral-900 dark:text-white"
                    />
                    <Text className="ml-2 font-medium text-base text-neutral-500 dark:text-neutral-400">
                      %
                    </Text>
                  </BlurView>
                </View>
              ...
              <View className="overflow-hidden rounded-2xl border border-neutral-200 bg-white/50 dark:border-neutral-800 dark:bg-transparent">
                ...
                >
                  <TextInput
                    ...
                    placeholder="e.g., Wallet, Home safe, Car"
                    placeholderTextColor={
                      isDark ? "rgba(255,255,255,0.3)" : "rgba(0,0,0,0.3)"
                    }
                    className="font-medium text-base text-neutral-900 dark:text-white"
                ...
                <View className="flex-row flex-wrap gap-2">
                  {INVESTMENT_TYPES.map((type) => (
                    ...
                    >
                      ...
                      >
                        <BlurView
                          intensity={investmentType === type ? 90 : 80}
                          tint={isDark ? "dark" : "light"}
                          className="px-4 py-2"
                        >
                          <Text
                ...
                <View className="flex-row flex-wrap gap-2">
                  {ASSET_CATEGORIES.map((category) => (
                    ...
                    >
                      ...
                      >
                        <BlurView
                          intensity={assetCategory === category ? 90 : 80}
                          tint={isDark ? "dark" : "light"}
                          className="px-4 py-2"
                        >
                          <Text
                ...
                >
                  <View className="flex-row items-center">
                    <View
                      ...
                      className="mr-4 h-10 w-10 items-center justify-center rounded-full opacity-20"
                    >
                      <Ionicons
                        name={selectedIcon as any}
                        size={20}
                    ...
                    <View className="items-end">
                      <Text className="mb-0.5 font-medium font-mono text-base text-neutral-900 dark:text-white">
                        {balance
                          ? `${currency.symbol}${Number(balance).toLocaleString("en-US", {
